...
FILES=(00_VARS.sh settimezone.sh setlocales.sh sethostname.sh users.sh conf-hosts.sh enable-services.sh sudoers.sh genswapfile.sh set-aurhelper.sh set-firewall.sh initramfs.sh bootloader.sh)
